...
public class GameManager : MonoBehaviour
{
    ...
    private _Player white;
    private _Player black;
    public _Player currentPlayer;
    public _Player otherPlayer;
    ...
    void Start()
    {
        ...
        white = new _Player("white", true);
        black = new _Player("black", false);
    ...
    public void AddPiece(GameObject prefab, _Player player, int col, int row)
    {
    ...
    {
        _Piece piece = pieceObject.GetComponent<_Piece>();
    ...
    {
        _Piece pieceComponent = piece.GetComponent<_Piece>();
    ...
    public void CapturePieceAt(Vector2Int gridPoint)
    {
        ...
        if (pieceToCapture.GetComponent<_Piece>().type == PieceType.King)
        {
            Debug.Log(currentPlayer.name + " wins!");
            Destroy(board.GetComponent<_TileSelector>());
            Destroy(board.GetComponent<_MoveSelector>());
        }
    ...
    {
        _Player tempPlayer = currentPlayer;
